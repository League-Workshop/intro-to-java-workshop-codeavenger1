	...
	public static void main(String[] args) {
		...
		while (playerHealth > 0 && dragonHealth > 0) { // this line of code keeps the battle going until someone's
			...
			if (yellKick.equals("kick")) {
				...
				Random random = new Random();
				int twentyFiveRandom = random.nextInt(26);
				
				// -- Subtract that number from the dragon's health variable
				dragonHealth = dragonHealth - twentyFiveRandom;
			}
			
			// 11. Find a random number between 0 and 35 and store it in playerDamage
			Random random = new Random();
			playerDamage = random.nextInt(36);
			...
			// 14. Else if the dragon's health is less than or equal to 0
				...
				JOptionPane.showMessageDialog(null, "Your dragon is dead. You won a ton of gold!");
			}
			...
			// each player this round)
				JOptionPane.showMessageDialog(null, "Your current health is " + playerHealth + 
						". And the dragon's health is " + dragonHealth + ".");
